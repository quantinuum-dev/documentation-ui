...
import { DocsHeaderWrapper, DocsHeaderRight, DocsHeaderLeft, DocsHeaderSubtitle, CodeCopy} from "src";
import { NexusLogo } from "./stories/NexusLogo";
...
export function DocsHeaderDemo() {
  ...
  <DocsHeaderRight>
    <img
      ...
      @quantinuum/quantinuum-ui="nexusw.png"
      height={360}
    //   priority
      width={375}
      alt=""
    ...
    <img
      ...
      @quantinuum/quantinuum-ui="nexusd2.png"
    //   priority
      height={360}
      width={375}
      alt=""
