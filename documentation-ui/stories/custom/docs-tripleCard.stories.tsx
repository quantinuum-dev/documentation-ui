...
const tripleCardProps = [
  {
    ...
    links: [
      ...
      },
      {
        ...
        description:
          'Learn about our tools for managing users, allocating resources, and visualizing activity.',
    ...
    links: [
      {
        ...
        description:
          'Get started with using client Python package to run workflows and retrieve your data.',
        link: 'examples/notebooks/getting_started.html',
      },
      {
        title: 'Nexus Lab',
        description:
          'Use our hosted Nexus Lab JupyterHub environment to get started coding in Python immediately, pre-configured with Quantinuum software packages like TKET and qnexus.',
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        description:
          'Examples of core qnexus usage and tutorials for more complex applied workflows using Nexus.',
...
export function DocsTripleCardDemo() {
  return (
    <DocsTripleCard
      cards={tripleCardProps}
      linkComponent={(props: ComponentProps<'a'>) => <a {...props}></a>}
      imageComponent={(props: ComponentProps<'img'>) => <img {...props}></img>}
    />
  )
}
